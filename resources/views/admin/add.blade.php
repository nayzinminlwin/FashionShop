    ...
    <div class="container">
      ...
      <div id="my-nav" class="collapse navbar-collapse">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item active"> <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Add</a></li>
    ...
    <div class="card"> <img class="card-img" src="<?php echo url('/'); ?>/img/girl1.jpg" alt="">
      <div class="card-img-overlay">
        <div class="center-text">
          <h2 class="card-title">This page is Add page for Adorable admin.</h2>
           </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-12 content-us">
          ...
          @csrf
            <div class="contact-form" id="contact">
              <h3 class="text-uppercase">Add item</h3>
              <input type="text" name="iname" class="form-control" placeholder="Item Name" required>
              ...
              <input type="text" name="iprice" class="form-control" placeholder="Price" required>
              <input type="text" name="icolor" class="form-control" placeholder="Color" required>
              <input type="text" name="isize" class="form-control" placeholder="Size" required>
              <input type="text" name="icount" class="form-control" placeholder="Count" required>
              <textarea class="form-control" placeholder="Description" name="idescription"></textarea>
