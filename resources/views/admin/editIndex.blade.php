    ...
    <div class="card"> <img class="card-img" src="<?php echo url('/'); ?>/img/girl1.jpg" alt="">
      <div class="card-img-overlay">
        <div class="center-text">
          <h2 class="card-title">This page is Edit page for Excellent admin.</h2>
           </div>
      	</div>
       </div>
	</div>
                ...
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                    	<a href="/onlineShop/Admin/Edit/{{$catID=6}}/{{$acessory->id}}">
                          <h5>Edit</h5>
                      	</a>
                    </div>
                  </div>
            ...
            <div class="bx bx-1 myBox" style=" width:450px; height:600px ">
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                    	<a href="/onlineShop/Admin/Edit/{{$catID=5}}/{{$bkk->id}}">
                      		<h5>Edit</h5>
                      	</a>
                    </div>
            ...
            <div class="bx bx-1 myBox" style=" width:450px; height:500px ">
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                      <a href="/onlineShop/Admin/Edit/{{$catID=8}}/{{$bottom->id}}">
                      	<h5>Edit</h5>
                      </a>
                    </div>
                  </div>
            ...
            <div class="bx bx-1 myBox" style=" width:450px; height:600px ">
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                    	<a href="/onlineShop/Admin/Edit/{{$catID=2}}/{{$cosmetic->id}}">
                      		<h5>Edit</h5>
                      	</a>
                    </div>
            ...
            <div class="bx bx-1 myBox" style=" width:450px; height:600px ">
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                    	<a href="/onlineShop/Admin/Edit/{{$catID=4}}/{{$dress->id}}">
                      		<h5>Edit</h5>
                      	</a>
                    </div>
            ...
            <div class="bx bx-1 myBox" style=" width:450px; height:600px ">
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                    	<a href="/onlineShop/Admin/Edit/{{$catID=7}}/{{$food->id}}">
                      		<h5>Edit</h5>
                      	</a>
                    </div>
            ...
            <div class="bx bx-1 myBox" style=" width:450px; height:600px ">
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                    	<a href="/onlineShop/Admin/Edit/{{$catID=3}}/{{$shoe->id}}">
                      		<h5>Edit</h5>
                      	</a>
                    </div>
            ...
            <div class="bx bx-1 myBox" style=" width:450px; height:600px ">
                <div class="card" >   
                  ...
                  <div class="card-img-overlay"> 
                    ...
                    <div style="position: absolute;bottom: 8px;right: 16px;" >
                    	<a href="/onlineShop/Admin/Edit/{{$catID=1}}/{{$top->id}}">
                      		<h5>Edit</h5>
                      	</a>
                    </div>
