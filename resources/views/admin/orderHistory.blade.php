          ...
          <div class="container">
            ...
            <div id="my-nav" class="collapse navbar-collapse">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item active"> <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">OrderHistory</a></li>
      ...
      <div class="blog-content-bckg">
        <div class="blog-content-inner" id="ggs">
            ...
            <div class="container-fluid" id="blogNews" >
              @if($users!=NULL)
                <h2 class="card-title">Items in order History</h2>
                @foreach($users as $user)
                  ...
                  @endforeach
                        ...
                        <div class="row single-blog">
                          ...
                          <div class="col-xl-auto col-lg-12">
                            <a href="/onlineShop/Admin/UndoDelivered/{{$user->id}}" class="btn" style="background:white;">Undo deliver!</a>
                          </div> 
                        </div>
              ...
              @else
                <h2>No item in deliver history!</h2>
              @endif
